...
@Service
public class ExecuteFindParkingControlPeriodTypeByIdUseCaseImpl implements IExecuteFindParkingControlPeriodTypeByIdUseCase {

    private final IParkingControlPeriodTypeDomainService iParkingControlPeriodTypeDomainService;

    public ExecuteFindParkingControlPeriodTypeByIdUseCaseImpl(IParkingControlPeriodTypeDomainService iParkingControlPeriodTypeDomainService) {
    ...
    public CustomData<ParkingControlPeriodTypeDomainEntityOutput> execute(ParkingControlPeriodTypeDomainEntityInput input) {
        final var output = iParkingControlPeriodTypeDomainService.findParkingControlPeriodTypeById(input);
